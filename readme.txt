...
1. Build
Issue 'mvn package' command from the root project to build the plugin. Resulting package, teamcity-vsx-gallery.zip, will be copied to the plugins directory,
